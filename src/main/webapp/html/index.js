var pageNo = 1,
    ...
    currActive = "<span class='sr-only'>(current)</span>";
...
//   $.getJSON('../../app/board/list?pageNo=' + pn + '&pageSize=' + pageSize, 
//     function(obj) {
...
//       // 현재 페이지의 번호를 갱신한다.
//       $('span > .sr-only').
//       currSpan.html(String(pageNo) + currActive);
...
function loadList() {
  ...
  $.getJSON('../../bowtech/app/board/list', 
    function(obj) {
